...
csvs = ["odds_data_europe_2020.csv", "odds_data_europe_2016.csv", "odds_data_worlds_2022.csv", "odds_data_worlds_2018.csv", "odds_data_worlds_2014.csv", "odds_data_friendly.csv"]
